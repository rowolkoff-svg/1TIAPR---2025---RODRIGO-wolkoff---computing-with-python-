...
if n % 2 == 0:
    ...
    print("é impar")  # sem acento para parecer mais "humano"
...
if idade >= 18:
    ...
    print("vc ainda é menor")  # linguagem mais informal
...
if nota >= 6:
    ...
    print("reprovou")  # mensagem direta, sem pontuação
...
if n1 > n2:
    ...
    print("iguais")  # mensagem bem simples
...
if user == "admin" and senha == "1234":
    ...
    print("acesso negado")  # sem capitalização, estilo iniciante
...
if num % 2 == 0:
    ...
    print("multiplo de 5")  # sem acento
else:
    print("outro")  # mensagem bem curta
...
if temp < 0:
    ...
    print("quente demais")  # linguagem mais informal
...
if op == "+":
    ...
    print("operação invalida")  # sem acento
